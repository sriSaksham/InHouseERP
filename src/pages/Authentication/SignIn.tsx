...
import YourGifSource from '../../images/1.gif';
    ...
    const handleLogin = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (response.status === 200 && response.data.jwt) {
          ...
          localStorage.setItem('authToken', token); // Store token with 'Bearer' prefix
          localStorage.setItem('userId', decodedToken.id);
          localStorage.setItem('name', decodedToken.Name);
          localStorage.setItem('role', decodedToken.role);
          localStorage.setItem('username', decodedToken.username); // Store token with 'Bearer' prefix
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <img className="hidden dark:block"  src={Logo} alt="Logo" height={90}  width={150} />
              <img className="dark:hidden"  src={LogoDark}  alt="Logo"  height={90}  width={150} />
              ...
              <span className="mt-15 inline-block">
                <svg
                  ...
                  <path
                    ...
                    fill="white"
                  />
                 <image href={YourGifSource}  x="110"   y="90"  width="90"  height="90"  />
