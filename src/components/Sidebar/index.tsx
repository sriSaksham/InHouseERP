...
}, [isAuthenticated, pathname, userRole, navigate]);
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                      <svg fill="#ffffff" width="23px" height="23px" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg"><defs><style></style></defs><title>inventory-management</title><rect x="19" y="24" width="4" height="4"/><rect x="26" y="24" width="4" height="4"/><rect x="19" y="17" width="4" height="4"/><rect x="26" y="17" width="4" height="4"/><path 
...
/></svg>
                      ...
                      >
                        ...
                        <li>
                          ...
                          <li>
                            <NavLink
                              to="/admin/quantity/requests"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              View Quantity Requests
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/admin/approvedRequests"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                         <svg width="28px" height="26px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" mirror-in-rtl="true">
  <path fill="#ffffff" d="M7 11c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2s2 .9 2 2v1c0 1.1-.9 2-2 2zm-2 6.993L9 18c.55 0 1-.45 1-1v-2c0-1.65-1.35-3-3-3s-3 1.35-3 3v2c0 .552.448.993 1 .993zM19 18h-6c-.553 0-1-.447-1-1s.447-1 1-1h6c.553 0 1 .447 1 1s-.447 1-1 1zm0-4h-6c-.553 0-1-.448-1-1s.447-1 1-1h6c.553 0 1 .448 1 1s-.447 1-1 1zm0-4h-6c-.553 0-1-.448-1-1s.447-1 1-1h6c.553 0 1 .448 1 1s-.447 1-1 1z"/>
  <path fill="#ffffff" d="M22 2H2C.9 2 0 2.9 0 4v16c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 17.5c0 .28-.22.5-.5.5h-19c-.28 0-.5-.22-.5-.5v-15c0-.28.22-.5.5-.5h19c.28 0 .5.22.5.5v15z"/>
</svg>
                        Attendance Stats
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                          ...
                          <svg fill="#ffffff" width="23px" height="23px" viewBox="0 0 32 32" id="meteor-icon-kit__regular-inventory"  xmlns="http://www.w3.org/2000/svg">
<path fillRule="evenodd" clipRule="evenodd" fill="#ffffff"   d="M2 1C2 0.447715 1.55228 0 1 0C0.447715 0 0 0.447715 0 1V23C0 23.5523 0.447715 24 1 24C1.55228 24 2 23.5523 2 23V22H22V23C22 23.5523 22.4477 24 23 24C23.5523 24 24 23.5523 24 23V1C24 0.447715 23.5523 0 23 0C22.4477 0 22 0.447715 22 1V8H20V3C20 2.44772 19.5523 2 19 2H11C10.4477 2 10 2.44772 10 3V4H5C4.44772 4 4 4.44772 4 5V8H2V1ZM10 6H6V8H10V6ZM2 10V20H4V13C4 12.4477 4.44772 12 5 12H13C13.5523 12 14 12.4477 14 13V14H19C19.5523 14 20 14.4477 20 15V20H22V10H2ZM18 8V4H12V8H18ZM12 20H6V14H12V20ZM14 20V16H18V20H14Z"/>
                      ...
                      >
                        ...
                        <li>
                          ...
                          <li>
                            <NavLink
                              to="/inventory/quantityRequeststatus"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <li>
  {!localStorage.getItem('authToken') && ( // Check if the user is not authenticated
    <NavLink
      to="/auth/signin"
      className={({ isActive }) =>
        'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
